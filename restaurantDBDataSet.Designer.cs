...
namespace Restaurant_Management_System {
    ...
    public partial class restaurantDBDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(int EmployeeID, string Username, string Password, string LastName, string FirstName, string Phone, string Image, string Role, decimal Salary) {
...
namespace Restaurant_Management_System.restaurantDBDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Image = 1 AND [Image] IS NULL) OR ([Image] = @Original_Image)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([EmployeeID], [Username], [Password], [LastName], [FirstName], [Phone], [Image], [Role], [Salary]) VALUES (@EmployeeID, @Username, @Password, @LastName, @FirstName, @Phone, @Image, @Role, @Salary);
SELECT EmployeeID, Username, Password, LastName, FirstName, Phone, Image, Role, Salary FROM Employees WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [EmployeeID] = @EmployeeID, [Username] = @Username, [Password] = @Password, [LastName] = @LastName, [FirstName] = @FirstName, [Phone] = @Phone, [Image] = @Image, [Role] = @Role, [Salary] = @Salary WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Image = 1 AND [Image] IS NULL) OR ([Image] = @Original_Image)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)));
SELECT EmployeeID, Username, Password, LastName, FirstName, Phone, Image, Role, Salary FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Restaurant_Management_System.Properties.Settings.Default.restaurantDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Username, string Original_Password, string Original_LastName, string Original_FirstName, string Original_Phone, string Original_Image, string Original_Role, global::System.Nullable<decimal> Original_Salary) {
        ...
        public virtual int Insert(int EmployeeID, string Username, string Password, string LastName, string FirstName, string Phone, string Image, string Role, global::System.Nullable<decimal> Salary) {
        ...
        public virtual int Update(
                    ...
                    string Original_Role, 
                    global::System.Nullable<decimal> Original_Salary) {
            return this.Update(Original_EmployeeID, Username, Password, LastName, FirstName, Phone, Image, Role, Salary, Original_EmployeeID, Original_Username, Original_Password, Original_LastName, Original_FirstName, Original_Phone, Original_Image, Original_Role, Original_Salary);
        }
    }
